...
# 按需安装适配器
npm install @ppyuesheng/sdk-h5-adapter-vue    # Vue应用
npm install @ppyuesheng/sdk-h5-adapter-js     # 普通JS应用
npm install @ppyuesheng/sdk-h5-adapter-rn     # React Native应用
```
...
| 包名 | 功能 | 大小 |
|------|------|------|
| `@ppyuesheng/sdk-h5-core` | 核心SDK功能 | ~10KB |
| `@ppyuesheng/sdk-h5-transport-loki` | Loki传输层 | ~3KB |
| `@ppyuesheng/sdk-h5-adapter-js` | 原生JS适配器 | ~1KB |
| `@ppyuesheng/sdk-h5-adapter-vue` | Vue.js适配器 | ~1KB |
| `@ppyuesheng/sdk-h5-adapter-rn` | React Native适配器 | ~1KB |
